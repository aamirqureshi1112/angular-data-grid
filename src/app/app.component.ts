...
export class AppComponent {
	...
	inputRenderer(params) {
		...
		switch (params.value) {
			...
			case 'checkbox':
				eGui = document.createElement('input');
				eGui.type = 'checkbox';
				return eGui;
			...
			case 'textArea':
				eGui = document.createElement('textarea');
				return eGui;

			default:
				eGui = document.createElement('a');
				eGui.href = params.value;
				eGui.innerHTML = params.value;
				return eGui;
		}
	}
	addColumn() {
		const randomColumn = Math.floor(Math.random() * this.columnDefs.length);
    	this.columnDefs.push(this.columnDefs[randomColumn]);
	...
	constructor() {
		...
		this.columnDefs = [
			{ field: 'inputType', cellRenderer: this.inputRenderer },
			{ field: 'position' },
			{ field: 'name' },
			{ field: 'weight' },
			{ field: 'density' },
			{ field: 'symbol' },
			{ field: 'source', cellRenderer: this.inputRenderer }
		];
